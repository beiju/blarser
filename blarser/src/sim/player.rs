...
pub struct PlayerDiffTest<'exp, 'obs> {
    pub id: <Uuid as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub name: <String as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub ritual: <String as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub fate: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub soul: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub blood: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub coffee: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub peanut_allergy: <bool as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub league_team_id: <Uuid as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub tournament_team_id: <Option<Uuid> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub deceased: <bool as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub evolution: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub items: <Vec<Item> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub state: <PlayerState as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub hit_streak: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub consecutive_hits: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub game_attr: <Vec<String> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub week_attr: <Vec<String> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub seas_attr: <Vec<String> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub item_attr: <Vec<String> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub perm_attr: <Vec<String> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub buoyancy: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub cinnamon: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub coldness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub chasiness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub divinity: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub martyrdom: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub base_thirst: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub indulgence: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub musclitude: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub tragicness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub omniscience: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub patheticism: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub suppression: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub continuation: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub ruthlessness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub watchfulness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub laserlikeness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub overpowerment: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub tenaciousness: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub thwackability: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub anticapitalism: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub ground_friction: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub pressurization: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub unthwackability: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub shakespearianism: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub moxie: <Cached<Ranged<f32>> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub total_fingers: <i32 as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub defense_rating: <MaybeKnown<f32> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub hitting_rating: <MaybeKnown<f32> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub pitching_rating: <MaybeKnown<f32> as PartialInformationCompare<'exp, 'obs>>::Diff,
    pub baserunning_rating: <MaybeKnown<f32> as PartialInformationCompare<'exp, 'obs>>::Diff,
}
